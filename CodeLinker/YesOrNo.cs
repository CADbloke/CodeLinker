...
namespace CodeLinker
{
    internal static class YesOrNo
    {
        ...
        /// <summary> Ask a question in a <c> Windows.Forms.MessageBox </c>. Returns <c> True </c> for Yes, <c> False </c> for no,
        ///     or <c> Null </c> if user cancels. </summary>
        /// <param name="message"> The question you are asking. </param>
        /// <param name="caption"> The caption for the Messagebox. Default is &quot;Hey!&quot; </param>
        ...
        internal static void Crashing(string message, string caption = "Hey!") { Console.WriteLine(message); }
    }
}
